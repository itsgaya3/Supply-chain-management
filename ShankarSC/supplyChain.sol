...
contract SupplyChain {
    ...
    function verifyManufacturer(address mfgaddress)
        public
        view
        returns (bytes32, bytes32)
    {
        return (
            manufacturerDetails[mfgaddress].mfgName,
            manufacturerDetails[mfgaddress].mfgLocation
        );
    }
    ...
    {
        return (
            partnerDetails[_partnerAddress].partnerName,
            partnerDetails[_partnerAddress].partnerLocation,
            partnerDetails[_partnerAddress].role
        );
    }
    ...
    function verifyProduct(bytes32 _proId)
        public
        view
        returns (
            bytes32,
    ...
    {
        return (
            productDetails[_proId].proName,
            productDetails[_proId].proState,
            productDetails[_proId].timeStamp,
            productDetails[_proId].partAddress
        );
    }
}
