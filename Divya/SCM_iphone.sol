...
contract SupplyChain{
    ...
    function verifyManufacturer(address _mfgAddress)
        public
        view
        returns (bytes32 _mfgName, bytes32 _mfgLocation)
    {
        return (
            mfgAddress[_mfgAddress].mfgName,
            mfgAddress[_mfgAddress].mfgLocation
        );
    }
    ...
    function verifyPartner(address _partnerAddress)
        public
        view
        returns (
            bytes32 _partnerName,
    ...
    {
        return (
            partnerAddress[_partnerAddress].partnerName,
            partnerAddress[_partnerAddress].partnerLocation,
            partnerAddress[_partnerAddress].role
        );
    }
    ...
    function verifyProduct(uint256 _proId)
        public
        view
        returns (
            bytes32 _proName,
    ...
    {
        return (
            Products[_proId].proName,
            Products[_proId].proState,
            Products[_proId].timeStamp,
            Products[_proId].partAddress
        );
    }
}
